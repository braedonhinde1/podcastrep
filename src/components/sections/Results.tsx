...
const credentials = [
  {
    ...
    value: "$2M+",
    label: "In Podcast Ad Revenue Closed",
    description: "Personally negotiated and closed over $2 million in podcast advertising deals across dozens of brands and shows.",
  },
  {
    icon: (
      <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth={1.5} className="w-8 h-8">
    ...
    value: "Director",
    label: "Podcast Ad Sales",
    description: "Years of hands-on experience in podcast advertising — from prospecting and pitching to negotiation and close.",
  },
  {
    icon: (
      <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth={1.5} className="w-8 h-8">
      ...
      <div className="max-w-6xl mx-auto">
        <FadeUp className="text-center mb-16">
          ...
          <p className="mt-4 text-[var(--color-text-secondary)] max-w-xl mx-auto">
            This isn&apos;t a side project. Podcast ad sales is what we do every day — and the numbers speak for themselves.
          </p>
        </FadeUp>
